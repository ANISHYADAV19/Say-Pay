        ...
        {examples.map((ex) => (
          <li key={ex}>
            <button
              ...
              disabled={disabled}
              onClick={() => onTry(ex)}
              className="glass glass-interactive w-full rounded-xl px-4 py-2.5 text-stone-700 hover:text-accent disabled:opacity-50 dark:text-stone-200 dark:hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
            >
              “{ex}”
            </button>
          </li>
